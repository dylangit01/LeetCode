...
/* ideas:
    ...
    3. we only compare the end number of pre interval and the start number of next interval, if there is overlapping, then merge them also save them into result;
        if not overlapping, we need to save both intervals into res.
    4. return res
 */
...
var merge = function(intervals) {
    ...
    for(let i = 0; i < intervals.length; i ++ ){
        // variable pre is the last position interval in the res, it will change when looping i
        ...
        // then we push this interval[i] into res []
